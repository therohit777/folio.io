...
const Navbar = () => {
  ...
  return (
    <div className={(hidmenu)?'Navbar':'Navbar navheight'}>
        ...
        <a href="https://drive.google.com/file/d/1CknZTU_k01x503cj1QQOIDL8oD82Z_D6/view?usp=sharing" target='_blank' rel="noreferrer" className={(hidmenu)?'cvbutton':'cvbutton showup'}>Download CV</a>
